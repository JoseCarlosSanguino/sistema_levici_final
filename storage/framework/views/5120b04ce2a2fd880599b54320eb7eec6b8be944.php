                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th><th>Tipo de unidad</th><th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php $__currentLoopData = $unittypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                        ...
                        <div class="pagination-wrapper"> <?php echo $unittypes->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
