                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th><th>Tipo de producto</th><th>Vendible</th><th>Alquilable</th><th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php $__currentLoopData = $producttypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->producttype); ?></td>
                                    <td><?php echo e(($item->salable)?'Si':'No'); ?></td>
                                    <td><?php echo e(($item->rentable)?'Si':'No'); ?></td>
                                    <td>
                        ...
                        <div class="pagination-wrapper"> <?php echo $producttypes->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
