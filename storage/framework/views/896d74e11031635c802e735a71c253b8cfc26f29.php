                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th><th>Ciudad</th><th>Provincia</th><th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->province->province); ?></td>
                                    <td>
                        ...
                        <div class="pagination-wrapper"> <?php echo $cities->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
