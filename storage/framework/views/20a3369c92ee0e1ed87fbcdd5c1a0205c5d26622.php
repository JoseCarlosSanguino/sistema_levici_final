                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $cylinders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(isset($loop->iteration) ? $loop->iteration : $item->id); ?></td>
                                    <td><?php echo e($item->code); ?></td>
                                    <td><?php echo e(isset($item->external_code) ? $item->external_code : ''); ?></td>
                                    <td><?php echo e($item->cylindertype->cylindertype); ?></td>
                                    <td><?php echo e(isset($item->expiration) ? $item->expiration : ''); ?></td>
                                    <td> <?php if($item->is_own == 1): ?> Propio <?php else: ?> <?php if(!is_null($item->provider_id)): ?> <?php echo e(isset($item->provider->name) ? $item->provider->name : ''); ?> <?php endif; ?> <?php endif; ?></td>
                        ...
                        <div class="pagination-wrapper"> <?php echo $cylinders->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
