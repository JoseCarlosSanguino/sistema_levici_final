            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->name); ?></td><td><?php echo e($item->cuit); ?></td><td><?php echo e($item->telephone); ?></td><td><?php echo e($item->web); ?></td>
                                    <td>
                        ...
                        <div class="pagination-wrapper"> <?php echo $providers->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
