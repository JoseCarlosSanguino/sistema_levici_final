...
<div class="form-group">
    ...
    <div class="col-xs-2">
        {!! Form::text('date_of', isset($purchase->date_of) ? $purchase->date_of : date('d/m/Y'),['class'=>'form-control datepicker']); !!}
    </div>
</div>
</br>
<div class="form-group">
    ...
    <div class="col-xs-4">
        {!! Form::text('provider_ac', '',['id'=>'provider_ac', 'autocomplete' => 'off' ,'class'=>'typeahead form-control']); !!}
        {!! Form::hidden('provider_id', '', ['id' => 'provider_id']) !!}
    </div>
</div>
</br>
...
<div class="form-group">
    ...
    <div class="col-xs-10">
        {!! Form::text('observation', isset($purchase->operation->observation) ? $purchase->operation->observation : '',['class'=>'form-control']);!!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-xs-2">
        {!! Form::text('order_number', isset($purchase->order_number) ? $purchase->order_number : '',['class'=>'form-control']);!!}
    </div>
</div>
<br>
<h4>Detalle</h4>
