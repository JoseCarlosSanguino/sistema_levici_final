                            ...
                            @foreach($paychecks as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/'.$controller.'/discount/' . $item->id) }}" title="Ver {{$modelName}}"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i> Descontar</button></a>
                                        @endif
                                        <!--
